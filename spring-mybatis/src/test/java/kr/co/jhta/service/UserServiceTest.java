...
public class UserServiceTest {
	...
	public void testAddNewUser() {
		User user = new User("hong1234", "홍길동", "1234", "hong1234");
	...
	public void testDupplicatedAddUser() {
		User user = new User("hong1234", "홍길동", "1234", "hong1234");
	...
	public void testLogin() {
		User user = userService.login("hong", "zxcv1234");
